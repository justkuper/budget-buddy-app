...
export default function LoginPage() {
  ...
  const confirmModal = pendingProfile && (
  ...
  if (isDesktop) {
    return (
      <div className="auth-page auth-page--with-panel">
        {/* Left branding panel */}
          ...
          <div className="auth-features">
            <div className="auth-feature">
              ...
              <div className="auth-feature-text">
                <div className="auth-feature-title">Bank-level security</div>
                Plaid-powered connections with AES-256 encryption
              </div>
            </div>
            <div className="auth-feature">
              <span className="auth-feature-icon">📊</span>
              <div className="auth-feature-text">
                <div className="auth-feature-title">Smart budgeting</div>
            ...
            <div className="auth-feature">
              <span className="auth-feature-icon">🔐</span>
              <div className="auth-feature-text">
                <div className="auth-feature-title">Two-factor authentication</div>
                Protect your account with TOTP
              </div>
            </div>
          </div>
          <div style={{marginTop:'auto', paddingTop:48, display:'flex', gap:8}}>
            <button className="icon-btn-sm" style={{background:'rgba(255,255,255,0.2)'}} onClick={() => i18n.changeLanguage(i18n.language === 'en' ? 'es' : 'en')}>
              {i18n.language === 'en' ? '🇺🇸' : '🇪🇸'}
            </button>
            <button className="icon-btn-sm" style={{background:'rgba(255,255,255,0.2)'}} onClick={toggleTheme}>
              {isDark ? '☀️' : '🌙'}
            </button>
          </div>
        </div>
